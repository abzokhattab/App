...
const translations: TranslationDeepObject<typeof en> = {
    ...
    iou: {
        ...
        dynamicExternalWorkflowCannotSubmit: 'Este relatório não pode ser enviado. Por favor, revise os comentários para resolver.',
        dynamicExternalWorkflowCannotApprove: 'Este relatório não pode ser aprovado. Por favor, revise os comentários para resolver.',
        ...
        error: {
            ...
            genericDEWApproveFailureMessage: 'Falha na aprovação do fluxo de trabalho externo dinâmico',
