...
const translations: TranslationDeepObject<typeof en> = {
    ...
    iou: {
        ...
        queuedToApproveViaDEW: "en file d'attente pour être approuvé via le workflow d'approbation personnalisé",
        dynamicExternalWorkflowCannotSubmit: 'Ce rapport ne peut pas être soumis. Veuillez consulter les commentaires pour résoudre.',
        dynamicExternalWorkflowCannotApprove: 'Ce rapport ne peut pas être approuvé. Veuillez consulter les commentaires pour résoudre.',
        ...
        error: {
            ...
            genericDEWApproveFailureMessage: "Échec de l'approbation du flux de travail externe dynamique",
