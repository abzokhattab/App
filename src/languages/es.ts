...
${amount} para ${merchant} - ${date}`,
    ...
    workspace: {
        ...
        expensifyCard: {
            ...
            applyCashbackToBillDescription: 'Cuando está activado, el reembolso obtenido de los gastos con la Tarjeta Expensify se aplicará a tu factura de Expensify.',
            frequency: {
                daily: 'Cada día',
                monthly: 'Mensual',
            },
