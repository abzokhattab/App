...
const translations: TranslationDeepObject<typeof en> = {
    ...
    iou: {
        ...
        dynamicExternalWorkflowCannotApprove: 'Este informe no se puede aprobar. Revise los comentarios para solucionarlo.',
        ...
        error: {
            ...
            genericDEWApproveFailureMessage: 'Error al aprobar el flujo de trabajo externo dinámico',
