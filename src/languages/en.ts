...
const translations = {
    ...
    iou: {
        ...
        dynamicExternalWorkflowCannotApprove: "This report can't be approved. Please review the comments to resolve.",
        ...
        error: {
            ...
            genericDEWApproveFailureMessage: 'Dynamic External Workflow approval failed',
