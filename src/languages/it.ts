...
const translations: TranslationDeepObject<typeof en> = {
    ...
    iou: {
        ...
        dynamicExternalWorkflowCannotSubmit: 'Questo rapporto non può essere inviato. Si prega di rivedere i commenti per risolvere.',
        dynamicExternalWorkflowCannotApprove: 'Questo rapporto non può essere approvato. Si prega di rivedere i commenti per risolvere.',
        ...
        error: {
            ...
            genericDEWApproveFailureMessage: 'Approvazione del flusso di lavoro esterno dinamico non riuscita',
