...
const translations: TranslationDeepObject<typeof en> = {
    ...
    iou: {
        ...
        dynamicExternalWorkflowCannotApprove: 'Dit rapport kan niet worden goedgekeurd. Bekijk de opmerkingen om op te lossen.',
        ...
        error: {
            ...
            genericDEWApproveFailureMessage: 'Dynamische externe workflow goedkeuren mislukt',
